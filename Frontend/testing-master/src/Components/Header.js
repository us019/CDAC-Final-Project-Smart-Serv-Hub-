          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:{" "}
                <a className="text-white" href="tel: +91 9936842565">
                  +91 9936842565
                </a>
              </p>
            </div>
            ...
            <div className="col-5">
              <div className="input-group">
                <input
                  ...
                  aria-label="Search the Product Here"
              ...
              <div className="menu-bottom d-flex align-items-center gap-30">
                <div>
                  <div className="dropdown">
                    <button
                      className="btn btn-secondary dropdown-toggle bg-transparent boader-0 gap-15 d-flex align-items-center" 
                      type="button"
